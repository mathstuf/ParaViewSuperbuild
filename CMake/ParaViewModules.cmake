...
set(SUBPROJECT_GENERATOR "" CACHE STRING "The default generator to use for subprojects")
mark_as_advanced(SUBPROJECT_GENERATOR)
set(SUBPROJECT_BUILD_ARGS "" CACHE STRING "Extra build arguments to the build tool")
mark_as_advanced(SUBPROJECT_BUILD_ARGS)
  ...
  if (build-projects)
    ...
    foreach(arg IN LISTS project_arguments)
      if (arg STREQUAL "DEPENDS_OPTIONAL")
        set (mode optdeps)
      elseif (arg STREQUAL "CMAKE_GENERATOR")
        set (mode generator)
      elseif (arg MATCHES "${_ep_keywords_ExternalProject_Add}")
        set (mode FALSE)
      elseif (mode STREQUAL "optdeps")
        list(APPEND optional_depends "${arg}")
      elseif (mode STREQUAL "generator")
    ...
    if (NOT cmake_generator)
      set(cmake_generator "${SUBPROJECT_GENERATOR}")
    endif ()
    if (cmake_generator)
      list(APPEND arguments CMAKE_GENERATOR "${cmake_generator}")
    endif ()
